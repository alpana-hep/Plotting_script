...
void n30_fitting(string root_file_name,string map_file)
{
  ...
  sprintf(path2,"fittingn10_n20_n30/n30/",root_file_name.c_str());
  ...
  std::ofstream file;
  file.open("fit_function_parameters_n30.txt",ios::out);
  ...
  float Sigma_l[5066]={};
  //  float par[8];
  //for(int iModule = 0; iModule<3;iModule++)//(int(map_vec.size()));iModule++)
